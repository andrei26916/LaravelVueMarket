<template>
    <div>
        <header>
            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark" style="position: fixed;width: 100%;top: 0;z-index: 99;">
                        ...
                        <ul class="navbar-nav mr-auto">
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <router-link v-for="category in this.$root.categories"
                                                 :key="category.id"
...
<!--                                    <div class="dropdown-divider"></div>-->
                        ...
                        <form class="form-inline my-2 my-lg-0">
                            ...
                            <div v-if="this.$root.auth == 'false'" class="nav-item my-style">
                                <router-link :to="{name: 'auth'}" class="nav-item nav-link">Вход</router-link>
                            </div>

                            <div v-if="this.$root.auth == 'false'" class="nav-item my-style">
                                <router-link :to="{name: 'registration'}" class="nav-item nav-link">Регистрация</router-link>
                            </div>

                            <div v-else class="nav-item" style="margin-right: 40px">
                                <ul class="navbar-nav">
                                    <li class="nav-item dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="navbarDropdown" style="position: absolute">
                                            <router-link :to="{name: 'settings'}" class="dropdown-item">Настройки</router-link>
                                            <div class="dropdown-divider"></div>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-12 text-center">
                        <h2 class="footer-heading"><a href="#" class="logo">FSTORE</a></h2>
                        <ul class="ftco-footer-social p-0">
                            ...
                            <span >
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                     class="bi bi-instagram" viewBox="0 0 16 16"><path
